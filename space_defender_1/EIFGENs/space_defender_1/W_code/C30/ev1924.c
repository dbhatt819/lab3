...
extern void F1924_23743(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1924_23744(EIF_REFERENCE);
extern void F1924_23745(EIF_REFERENCE);
extern void F1924_23746(EIF_REFERENCE);
extern void F1924_23747(EIF_REFERENCE);
static EIF_TYPED_VALUE F1924_23748_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1924_23748(EIF_REFERENCE);
...
void F1924_23743 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1923, Current, 0, 0, 29685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1923, Current, 29685);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(15664, 1920))(Current);
	RTHOOK(2);
...
EIF_TYPED_VALUE F1924_23744 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1924_23745 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1923, Current, 1, 0, 29687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1923, Current, 29687);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1924_23746 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1923, Current, 1, 0, 29682);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1923, Current, 29682);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1924_23747 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1923, Current, 2, 0, 29683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1923, Current, 29683);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN)(loc2 != NULL)) {
		...
		for (;;) {
			...
			if (!RTCEQ(tr1, Current)) {
				...
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(7,1);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(19416, "disable_select", tr1))(tr1);
			}
			RTHOOK(8);
...
static EIF_TYPED_VALUE F1924_23748_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1923, Current, 0, 0, 29684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1923, Current, 29684);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1924_23748 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1924_23748_body (Current)).it_r;
