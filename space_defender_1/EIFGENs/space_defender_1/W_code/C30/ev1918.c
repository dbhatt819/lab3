...
extern void F1918_23663(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1918_23664_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1918_23664(EIF_REFERENCE);
...
void F1918_23663 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1917, Current, 0, 1, 29610);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1917, Current, 29610);
...
static EIF_TYPED_VALUE F1918_23664_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1917, Current, 0, 0, 29611);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1917, Current, 29611);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1918_23664 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1918_23664_body (Current)).it_r;
