...
extern void F1935_24146(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1935_24147(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1935_24148(EIF_REFERENCE);
extern void F1935_24149(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1935_24150(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1935_24151(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1935_24152(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1935_24153(EIF_REFERENCE);
extern void F1935_24154(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1935_24155_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1935_24155(EIF_REFERENCE);
...
void F1935_24146 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1934, Current, 0, 1, 30032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30032);
	RTCC(arg1, 1934, l_feature_name, 1, RTWCT(15669, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1935_24147 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1934, Current, 0, 0, 30033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30033);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1935_24148 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1935_24149 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1934, Current, 1, 1, 30025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30025);
	if (arg1) {
		RTCC(arg1, 1934, l_feature_name, 1, eif_new_type(1937, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1935_24150 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1934, Current, 2, 1, 30026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30026);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F1935_24151 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1934, Current, 2, 1, 30027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30027);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
void F1935_24152 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1934, Current, 3, 1, 30028);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30028);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_is_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1935_24153 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1934, Current, 0, 0, 30029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30029);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1935_24154 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1934, Current, 0, 2, 30030);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30030);
	RTCC(arg1, 1934, l_feature_name, 1, eif_new_type(1423, 0x01), 0x01);
	RTCC(arg2, 1934, l_feature_name, 2, eif_new_type(1518, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
static EIF_TYPED_VALUE F1935_24155_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1934, Current, 0, 0, 30031);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1934, Current, 30031);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1935_24155 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1935_24155_body (Current)).it_r;
