...
extern void F1994_3561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1994_3562(EIF_REFERENCE);
extern void F1994_3563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_3564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_3565(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1994_3566(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1994_3567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1994_3568(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1994_3561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 1, 1, 20448);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20448);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1994_3562 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1993, Current, 1, 0, 20449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20449);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F1994_3563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 0, 1, 20450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20450);
	RTCC(arg1, 1993, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F1994_3564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 0, 1, 20451);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20451);
	RTCC(arg1, 1993, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1994_3565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 0, 1, 20444);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20444);
	RTCC(arg1, 1993, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F1994_3566 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1993, Current, 0, 0, 20445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20445);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1994_3567 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1993, Current, 1, 0, 20446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20446);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1994_3568 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1993, Current, 3, 1, 20447);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1993, Current, 20447);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
