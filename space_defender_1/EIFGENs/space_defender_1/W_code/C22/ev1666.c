...
extern EIF_TYPED_VALUE F1666_18791(EIF_REFERENCE);
static EIF_TYPED_VALUE F1666_18810_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1666_18810(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1666_18791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1665, Current, 2, 0, 25434);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
	RTHOOK(18);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15719, dtype))(Current)).it_b);
	RTNHOOK(18,1);
	tr1 = (tb1 ? makestr ("True", 4) : makestr ("False", 5));
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
	RTHOOK(19);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15720, dtype))(Current)).it_b);
	RTNHOOK(19,1);
	tr1 = (tb1 ? makestr ("True", 4) : makestr ("False", 5));
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4821, "append", Result))(Result, ur1x);
...
static EIF_TYPED_VALUE F1666_18810_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1665, Current, 0, 0, 25435);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1666_18810 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1666_18810_body (Current)).it_r;
