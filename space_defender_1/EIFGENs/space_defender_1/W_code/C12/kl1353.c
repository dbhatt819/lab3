...
extern EIF_TYPED_VALUE F1353_14311(EIF_REFERENCE);
...
RTOID (F1353_14311)
EIF_TYPED_VALUE F1353_14311 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1352, Current, 0, 0, 20857);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
