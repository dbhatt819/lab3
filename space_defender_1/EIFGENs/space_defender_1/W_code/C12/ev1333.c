...
extern void F1333_14200(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1333_14201(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1332, Current, 0, 1, 20616);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1332, Current, 20616);
	{
	...
	*((EIF_INTEGER_32 *)tr3+1) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1333_184_2_3, (EIF_POINTER)(0),11788, tr2, 0, 1, -1, tr1, 2);
	}
	ur1 = RTCCL(tr4);
...
void F1333_14200 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1332, Current, 0, 3, 20617);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1332, Current, 20617);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,250,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1333_14201 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
