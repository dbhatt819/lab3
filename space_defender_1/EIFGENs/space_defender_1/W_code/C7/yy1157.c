...
extern void F1157_25527(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 17940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 2, 17941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 17942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 1, 17945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1156, Current, 0, 2, 17946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(9416, dtype)) = (EIF_BOOLEAN) tb1;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 9415, 0xF8000573, 0); /* file */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F1157_11644 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1156, Current, 0, 0, 17948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1156, Current, 3, 0, 17949);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1157_25527 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1156, Current, 0, 25526);
	RTSA(dtype);
	RTME(dtype, 0);
