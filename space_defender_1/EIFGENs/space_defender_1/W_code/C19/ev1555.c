...
extern EIF_TYPED_VALUE F1555_17448(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1555_17448 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1554, Current, 0, 0, 24106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1554, Current, 24106);
	RTIV(Current, RTAL);
	RTHOOK(1);
