...
extern EIF_TYPED_VALUE F1707_19464(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1707_19464 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1706, Current, 0, 0, 25895);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1706, Current, 25895);
	RTIV(Current, RTAL);
	RTHOOK(1);
