...
static EIF_TYPED_VALUE F1702_19446_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1702_19446_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1701, Current, 0, 0, 25886);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1701, Current, 25886);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1702_19446 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1702_19446_body (Current)).it_r;
