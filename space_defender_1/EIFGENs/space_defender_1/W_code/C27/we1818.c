...
extern EIF_TYPED_VALUE F1818_20800(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1818_20800 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1817, Current, 0, 0, 26839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1817, Current, 26839);
	RTIV(Current, RTAL);
	RTHOOK(1);
