...
extern void F1827_21011(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1827_21013(EIF_REFERENCE);
extern void F1827_21014(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1827_21011 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1826, Current, 2, 0, 27001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1826, Current, 27001);
	RTIV(Current, RTAL);
	...
	if (EIF_TEST(loc2)) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(17487, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		...
		if (tb1) {
			...
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(17488, dtype))(Current, up1x, up2x, up3x);
		} else {
			RTHOOK(7);
...
EIF_TYPED_VALUE F1827_21013 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1827_21014 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_p
	...
	RTEAA(l_feature_name, 1826, Current, 0, 3, 27003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1826, Current, 27003);
