...
extern EIF_TYPED_VALUE F1825_20990(EIF_REFERENCE);
...
RTOID (F1825_20990)
EIF_TYPED_VALUE F1825_20990 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1825_20990);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1824, Current, 0, 0, 26982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1824, Current, 26982);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
