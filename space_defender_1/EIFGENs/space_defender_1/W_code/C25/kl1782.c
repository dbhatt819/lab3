...
extern EIF_TYPED_VALUE F1782_20234(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1782_20234 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1781, Current, 0, 0, 26333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1781, Current, 26333);
	RTIV(Current, RTAL);
	RTHOOK(1);
