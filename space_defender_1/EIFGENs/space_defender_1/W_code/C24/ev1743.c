...
extern EIF_TYPED_VALUE F1743_19902(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1743_19905(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1743_19906_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1743_19906(EIF_REFERENCE);
...
/* {EV_TEXT_I}.search */
EIF_TYPED_VALUE F1743_19902 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1742, Current, 0, 2, 26115);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1742, Current, 26115);
	RTCC(arg1, 1742, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1743_19905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
/* {EV_TEXT_I}.interface */
static EIF_TYPED_VALUE F1743_19906_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1742, Current, 0, 0, 26117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1743_19906 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1743_19906_body (Current)).it_r;
