...
extern void F1721_19644(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1721_19645(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1721_19646_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1721_19646(EIF_REFERENCE);
...
/* {EV_CELL_I}.extend */
void F1721_19644 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1720, Current, 0, 1, 26014);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1720, Current, 26014);
	RTCC(arg1, 1720, l_feature_name, 1, RTWCT(16361, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1721_19645 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1720, Current, 1, 1, 26015);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTNHOOK(2,1);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(16357, "update_for_pick_and_drop", tr1))(tr1, ub1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
/* {EV_CELL_I}.interface */
static EIF_TYPED_VALUE F1721_19646_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1720, Current, 0, 0, 26016);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1721_19646 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1721_19646_body (Current)).it_r;
