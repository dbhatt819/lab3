...
extern void F1797_20622(EIF_REFERENCE);
extern void F1797_20623(EIF_REFERENCE);
...
void F1797_20622 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1796, Current, 26667);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1797_20623 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1796, Current, 0, 0, 26668);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1796, Current, 26668);
	RTIV(Current, RTAL);
