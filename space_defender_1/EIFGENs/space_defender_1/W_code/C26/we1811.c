...
extern EIF_TYPED_VALUE F1811_20760(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1811_20760 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1810, Current, 0, 0, 26799);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1810, Current, 26799);
	RTIV(Current, RTAL);
	RTHOOK(1);
