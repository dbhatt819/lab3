...
extern EIF_TYPED_VALUE F1802_20654(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1802_20655(EIF_REFERENCE);
extern void F1802_20656(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1802_20654 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1802_20655 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1802_20656 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1801, Current, 0, 0, 26695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1801, Current, 26695);
	RTIV(Current, RTAL);
