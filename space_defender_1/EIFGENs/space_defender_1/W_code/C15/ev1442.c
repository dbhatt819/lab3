...
#define ub1 ub1x.it_b
	...
	RTHOOK(5);
	RTDBGAA(Current, dtype, 10451, 0xF800029F, 0); /* accel_list */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(10522, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 32000L);
	...
	RTHOOK(12);
	up1 = loc3;
	tr1 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6522, "set_focus_event_string", loc1))(loc1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur1 = RTCCL(tr1);
	{
