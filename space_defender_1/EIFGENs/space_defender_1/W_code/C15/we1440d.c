...
static const EIF_TYPE_INDEX egt_13_1440 [] = {0xFF01,1019,0xFFFF};
...
static const struct desc_info desc_1440[] = {
	...
	{EIF_GENERIC(egt_13_1440), 22017, 0xFFFFFFFF},
...
void Init1440(void)
{
	...
	IDSC(desc_1440 + 34, 865, 1439);
	IDSC(desc_1440 + 44, 1117, 1439);
	IDSC(desc_1440 + 49, 1017, 1439);
}
