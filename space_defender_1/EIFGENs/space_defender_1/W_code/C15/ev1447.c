...
#define ui1_1 ui1_1x.it_i1
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10572, 0xF8000277, 0); /* column_titles */
	...
	*(EIF_REFERENCE *)(Current + RTWA(10572, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 10573, 0xF800037D, 0); /* column_widths */
	...
	*(EIF_REFERENCE *)(Current + RTWA(10573, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 10574, 0xF800037D, 0); /* column_alignments */
