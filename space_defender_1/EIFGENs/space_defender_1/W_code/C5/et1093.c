...
#define arg1 arg1x.it_r
	...
	*(EIF_REFERENCE *)(Current + RTWA(7164, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7166, 0xF800014E, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tb2 = *(EIF_BOOLEAN *)(loc4 + RTVA(7186, "value", loc4));
			ub1 = tb2;
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tc1 = *(EIF_CHARACTER_8 *)(loc4 + RTVA(7184, "value", loc4));
			uc1 = tc1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti8_1 = *(EIF_INTEGER_64 *)(loc4 + RTVA(7178, "value", loc4));
			ui8_1 = ti8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr8_1 = *(EIF_REAL_64 *)(loc4 + RTVA(7176, "value", loc4));
			ur8_1 = tr8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7182, "value", loc4))(loc4)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
