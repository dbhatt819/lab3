...
extern void F1034_25523(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1033, Current, 1, 0, 16212);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTLXI(loc1);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7684, 0xF800040E, 0); /* model */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7684, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7689, 0xF8000488, 0); /* sys */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7689, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7692, 0xF8000486, 0); /* ui */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7692, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7690, 0xF80004DC, 0); /* input */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7690, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7691, 0xF80004EB, 0); /* output */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7691, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(6,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10693, "model", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(6,2);
	...
	RTNHOOK(7,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10651, "on_error", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(7,2);
	{
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr5= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1260_35_2, (EIF_POINTER)(0),10692, tr3, 0, 1, -1, tr1, 1);
	}
	ur1 = RTCCL(tr5);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1033, Current, 0, 1, 16213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (RTEQ(arg1, RTMS_EX_H("man",3,7168366))) {
		...
		*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7690, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(7,1);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(10654, "parse_and_validate_input_string", tr1))(tr1);
		RTHOOK(8);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7690, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(8,1);
		tb1 = *(EIF_BOOLEAN *)(tr1 + RTVA(10648, "etf_error", tr1));
		if (tb1) {
			RTHOOK(9);
			RTDBGAA(Current, dtype, 7685, 0x04000000, 1); /* error */
			*(EIF_BOOLEAN *)(Current + RTWA(7685, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			...
			RTNHOOK(10,1);
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10688, "error_message", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4738, Dtype(tr1)))(tr1, ur1x);
			RTNHOOK(10,2);
			tr1 = RTCCL(tr1);
			...
			*(EIF_REFERENCE *)(Current + RTWA(7686, dtype)) = (EIF_REFERENCE) tr1;
			...
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7691, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10694, "model_state", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4738, Dtype(tr1)))(tr1, ur1x);
			RTNHOOK(16,2);
			tr1 = RTCCL(tr1);
...
void F1034_9910 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1033, Current, 0, 0, 16214);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1033, Current, 16214);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
{
	GTCX
	RTOTC (F1034_9911,16216,RTMS_EX_H("play(\012    row: MAX_ROW = 3 .. 10 ; \012    column: MAX_COLUMN = 5 .. 30 ; \012    player_mov: PLAYER_MOV = 1 .. 40 ; \012    project_mov: PROJECT_MOV = 1 .. 5\012)\012abort\012move(\012    row: ROW = {A, D, C, J, F, E, B, G, I, H} ; \012    column: COLUMN = 1 .. 30\012)\012pass\012fire\012undo\012redo",263,1698536047));
}

/* {ETF_MODEL_FACADE}._invariant */
void F1034_25523 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1033, Current, 0, 25522);
	RTSA(dtype);
	RTME(dtype, 0);
