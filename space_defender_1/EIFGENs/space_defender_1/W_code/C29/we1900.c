...
extern void F1900_23139(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
extern void F1900_23143(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {WEL_BUTTON}.make */
void F1900_23139 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x)
{
	GTCX
...
#define ui4_6 ui4_6x.it_i4
	...
	RTEAA(l_feature_name, 1899, Current, 0, 7, 29096);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29096);
	RTCC(arg1, 1899, l_feature_name, 1, eif_new_type(1867, 0x01), 0x01);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1899, Current, 0, 0, 29097);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29097);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1899, Current, 0, 0, 29098);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29098);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1900_23142 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1899, Current, 0, 0, 29099);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29099);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1900_23143 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1899, Current, 0, 1, 29100);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29100);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1899, Current, 0, 0, 29101);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1899, Current, 29101);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
