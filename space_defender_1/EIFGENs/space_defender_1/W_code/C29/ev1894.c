...
extern EIF_TYPED_VALUE F1894_22989(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1894_22990(EIF_REFERENCE);
extern void F1894_22991(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1894_22992(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1894_22993(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1894_22989 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1893, Current, 1, 0, 28946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1893, Current, 28946);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1894_22990 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1893, Current, 1, 0, 28947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1893, Current, 28947);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
void F1894_22991 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1893, Current, 0, 1, 28948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1893, Current, 28948);
	RTCC(arg1, 1893, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("exists", EX_PRE);
...
body:;
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		if (tb1) {
			RTHOOK(4);
			RTDBGAA(Current, dtype, 19075, 0xF80000EE, 0); /* internal_text */
		...
		RTHOOK(6);
		RTDBGAA(Current, dtype, 19075, 0xF80000EE, 0); /* internal_text */
		*(EIF_REFERENCE *)(Current + RTWA(19075, dtype)) = (EIF_REFERENCE) NULL;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1894_22992 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
RTOID (F1894_22993)
EIF_TYPED_VALUE F1894_22993 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F1894_22993);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1893, Current, 0, 0, 28950);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1893, Current, 28950);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(18567, 1892))(Current)).it_i4);
