...
extern EIF_TYPED_VALUE F1272_11328(EIF_REFERENCE);
extern void F1272_11329(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1272_11330(EIF_REFERENCE);
...
/* {EV_FONTABLE}.font */
EIF_TYPED_VALUE F1272_11328 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1271, Current, 0, 0, 18011);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1271, Current, 18011);
	RTIV(Current, RTAL);
...
void F1272_11329 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1271, Current, 0, 1, 18012);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1271, Current, 18012);
	RTCC(arg1, 1271, l_feature_name, 1, eif_new_type(1249, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1272_11330 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
