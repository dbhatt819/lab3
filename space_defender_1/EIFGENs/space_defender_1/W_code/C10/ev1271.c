...
/* {EV_ID_IMP}.make_id */
void F1271_13072 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1270, Current, 0, 0, 19319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1270, Current, 19319);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_ID_IMP}.id */
EIF_TYPED_VALUE F1271_13073 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(10773,Dtype(Current)));
	return r;
}
...
/* {EV_ID_IMP}.counter */
RTOID (F1271_13074)
EIF_TYPED_VALUE F1271_13074 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1270, Current, 0, 0, 19321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1270, Current, 19321);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1271_25530 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1270, Current, 0, 25529);
	RTSA(dtype);
	RTME(dtype, 0);
