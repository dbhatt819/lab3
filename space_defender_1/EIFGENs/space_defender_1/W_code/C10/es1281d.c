...
static const struct desc_info desc_1281[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 19484, 32},
	{EIF_NON_GENERIC(0x0197 /*203*/), 19485, 33},
	{EIF_GENERIC(egt_14_1281), 19486, 0},
	{EIF_GENERIC(egt_15_1281), 19487, 8},
	{EIF_GENERIC(egt_16_1281), 19488, 16},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 19489, 36},
	{EIF_GENERIC(egt_17_1281), 19490, 24},
};
void Init1281(void)
{
