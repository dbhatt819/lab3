...
extern void F1279_13225(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1279_13228(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1279_13229(EIF_REFERENCE);
extern void F1279_13230(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1279_13231(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1279_13232(EIF_REFERENCE);
extern void F1279_13233(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1279_13236(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1279_13237(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1279_13238(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F1279_13241(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1279_13242(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1279_13243_body(EIF_REFERENCE);
...
void F1279_13225 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_5 ui4_5x.it_i4
	...
	RTEAA(l_feature_name, 1278, Current, 11, 2, 19470);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19470);
	RTCC(arg1, 1278, l_feature_name, 1, eif_new_type(1207, 0x01), 0x01);
...
body:;
	RTHOOK(3);
	RTDBGAL(1, 0xF80004B8, 0, 0); /* loc1 */
	loc1 = RTCCL(arg1);
	loc1 = RTRV(eif_new_type(1208, 0x00), loc1);
	RTHOOK(4);
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		ur1 = RTCCL(loc4);
		ur2 = RTCCL(arg2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(12520, "save_bitmap_into", loc3))(loc3, ur1x, ur2x);
		RTHOOK(11);
		...
		if ((EIF_BOOLEAN)(loc2 != NULL)) {
			...
			ti4_1 = *(EIF_INTEGER_32 *)(loc2 + RTVA(10355, "scale_height", loc2));
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
				RTHOOK(17);
				ti4_1 = *(EIF_INTEGER_32 *)(loc9 + RTVA(11702, "height", loc9));
			} else {
				RTHOOK(18);
				ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(10355, "scale_height", loc2));
				ti4_1 = ti4_2;
			}
			loc8 = (EIF_INTEGER_32) ti4_1;
			RTHOOK(19);
			RTDBGAL(7, 0x10000000, 1, 0); /* loc7 */
			ti4_1 = *(EIF_INTEGER_32 *)(loc2 + RTVA(10354, "scale_width", loc2));
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
				RTHOOK(20);
				ti4_1 = *(EIF_INTEGER_32 *)(loc9 + RTVA(11703, "width", loc9));
			} else {
				RTHOOK(21);
				ti4_2 = *(EIF_INTEGER_32 *)(loc2 + RTVA(10354, "scale_width", loc2));
				ti4_1 = ti4_2;
			}
			...
			ti4_1 = *(EIF_INTEGER_32 *)(loc9 + RTVA(11703, "width", loc9));
			ui4_1 = ti4_1;
			ti4_2 = *(EIF_INTEGER_32 *)(loc9 + RTVA(11702, "height", loc9));
			ui4_2 = ti4_2;
			ui4_3 = loc7;
			ui4_4 = loc8;
			ti4_3 = *(EIF_INTEGER_32 *)(loc2 + RTVA(10356, "color_mode", loc2));
			ui4_5 = ti4_3;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10929, dtype))(Current, up1x, up2x, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ui4_5x);
		}
	}
	RTHOOK(28);
	ur1 = RTCCL(arg1);
	ur2 = RTCCL(arg2);
	ur3 = RTCCL(loc9);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10914, dtype))(Current, ur1x, ur2x, ur3x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(29);
	RTDBGLE;
...
void F1279_13228 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1278, Current, 17, 1, 19471);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19471);
	RTCC(arg1, 1278, l_feature_name, 1, eif_new_type(1278, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9891, "expose_actions_internal", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 9891, 0xF8000539, 0); /* expose_actions_internal */
		tr1 = RTCCL(loc1);
		RTAR(Current, tr1);
	...
	RTHOOK(33);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(10367, "pick_ended_actions_internal", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc17 = RTCCL(tr1);
	if (EIF_TEST(loc17)) {
		RTHOOK(34);
		RTDBGAA(Current, dtype, 10367, 0xF8000537, 0); /* pick_ended_actions_internal */
		tr1 = RTCCL(loc17);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(10367, dtype)) = (EIF_REFERENCE) tr1;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(35);
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 1278, Current, 14, 0, 19472);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19472);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ui4_2 = ti4_2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(11700, Dtype(tr1)))(tr1, ui4_1x, ui4_2x);
	RTNHOOK(1,1);
	...
	RTHOOK(11);
	RTDBGAL(14, 0xF8000653, 0, 0); /* loc14 */
	...
	RTHOOK(13);
	ur1 = RTCCL(loc14);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11717, "set_originating_pixmap", Result))(Result, ur1x);
	RTHOOK(14);
	...
	for (;;) {
		...
		ui4_1 = loc12;
		ui4_2 = loc13;
		tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10928, dtype))(Current, up1x, ui4_1x, ui4_2x)).it_n4);
		loc7 = (EIF_NATURAL_32) tu4_1;
		RTHOOK(22);
		uu4_1 = loc7;
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10925, dtype))(Current, uu4_1x)).it_n1);
		uu1_1 = tu1_1;
		ui4_1 = loc4;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2572, "put", loc6))(loc6, uu1_1x, ui4_1x);
		RTHOOK(23);
		uu4_1 = loc7;
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10926, dtype))(Current, uu4_1x)).it_n1);
		uu1_1 = tu1_1;
		ui4_1 = (EIF_INTEGER_32) (loc4 + ((EIF_INTEGER_32) 1L));
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2572, "put", loc6))(loc6, uu1_1x, ui4_1x);
		RTHOOK(24);
		uu4_1 = loc7;
		tu1_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10927, dtype))(Current, uu4_1x)).it_n1);
		uu1_1 = tu1_1;
	...
	if ((EIF_BOOLEAN)(loc1 != NULL)) {
		...
		if ((EIF_BOOLEAN)(loc10 != NULL)) {
			RTHOOK(36);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11598, "decrement_reference", loc10))(loc10);
		}
	}
	RTHOOK(37);
	...
	RTHOOK(39);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11598, "decrement_reference", loc11))(loc11);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(40);
	RTDBGLE;
...
void F1279_13230 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1278, Current, 0, 0, 19473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19473);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1278, Current, 0, 0, 19474);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19474);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800059B, 0,0); /* Result */
	tr1 = RTLNTY2(eif_new_type(1435, 0x01), 0x01);
	ub1 = (EIF_BOOLEAN) 1;
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10923, dtype))(Current, ub1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1278, Current, 0, 0, 19475);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19475);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800070D, 0,0); /* Result */
	tr1 = RTLNTY2(eif_new_type(1805, 0x01), 0x01);
	ub1 = (EIF_BOOLEAN) 0;
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10923, dtype))(Current, ub1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr2);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3884, "attempted", tr1))(tr1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
void F1279_13233 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1278, Current, 2, 1, 19476);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19476);
	RTCC(arg1, 1278, l_feature_name, 1, eif_new_type(1567, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(5);
	ur1 = RTCCL(loc2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(15761, "draw_to_drawable", loc1))(loc1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(6);
	RTDBGLE;
...
EIF_TYPED_VALUE F1279_13236 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1278, Current, 9, 1, 19477);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19477);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(12309, "set_unshared", loc1))(loc1);
	RTHOOK(3);
	ub1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14363, "set_is_icon", loc1))(loc1, ub1x);
	RTHOOK(4);
	RTDBGAL(5, 0xF8000598, 0, 0); /* loc5 */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10906, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc5 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	RTDBGAL(6, 0xF8000598, 0, 0); /* loc6 */
	...
	loc3 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(10);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11597, "enable_reference_tracking", loc3))(loc3);
	RTHOOK(11);
	ur1 = RTCCL(loc3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(12466, "select_bitmap", loc2))(loc2, ur1x);
	RTHOOK(12);
	RTDBGAL(4, 0xF8000471, 0, 0); /* loc4 */
	...
	if (tb1) {
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10922, dtype))(Current)).it_i4);
		ui4_4 = ti4_2;
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9177, "whiteness", loc4))(loc4)).it_i4);
		ui4_5 = ti4_3;
		...
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9166, "srcinvert", loc4))(loc4)).it_i4);
		ui4_7 = ti4_3;
		...
		ui4_5 = ((EIF_INTEGER_32) 0L);
		ui4_6 = ((EIF_INTEGER_32) 0L);
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9178, "maskpaint", loc4))(loc4)).it_i4);
		ui4_7 = ti4_3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(12512, "bit_blt", loc9))(loc9, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ur1x, ui4_5x, ui4_6x, ui4_7x);
		RTHOOK(23);
		...
		RTHOOK(25);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(12472, "unselect_bitmap", loc8))(loc8);
		RTHOOK(26);
		...
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10922, dtype))(Current)).it_i4);
		ui4_4 = ti4_2;
		ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9176, "blackness", loc4))(loc4)).it_i4);
		ui4_5 = ti4_3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(12518, "pat_blt", loc2))(loc2, ui4_1x, ui4_2x, ui4_3x, ui4_4x, ui4_5x);
	}
	RTHOOK(28);
	...
	RTHOOK(30);
	ur1 = RTCCL(loc6);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14362, "set_color_bitmap", loc1))(loc1, ur1x);
	RTHOOK(31);
	ur1 = RTCCL(loc3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(14361, "set_mask_bitmap", loc1))(loc1, ur1x);
	RTHOOK(32);
	if (arg1) {
		RTHOOK(33);
	...
	RTHOOK(37);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(11598, "decrement_reference", loc6))(loc6);
	RTHOOK(38);
	if ((EIF_BOOLEAN)(loc7 != NULL)) {
		RTHOOK(39);
...
void F1279_13237 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1278, Current, 0, 1, 19463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1279_13238 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 1278, Current, 0, 1, 19464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 1278, Current, 0, 1, 19465);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 1278, Current, 0, 1, 19466);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1278, Current, 19466);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1279_13241 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_i4
	...
	RTEAA(l_feature_name, 1278, Current, 0, 3, 19467);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1278, Current, 19467);
	RTIV(Current, RTAL);
...
void F1279_13242 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x, EIF_TYPED_VALUE arg6x, EIF_TYPED_VALUE arg7x)
{
	GTCX
...
#define arg7 arg7x.it_i4
	...
	RTEAA(l_feature_name, 1278, Current, 0, 7, 19468);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1278, Current, 19468);
...
static EIF_TYPED_VALUE F1279_13243_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1278, Current, 0, 0, 19469);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1278, Current, 19469);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1279_13243 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(10930, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1279_13243_body (Current)).it_r;
