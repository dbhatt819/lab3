...
extern EIF_TYPED_VALUE F1266_13024(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1266_13018 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19269);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1265, Current, 19269);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1266_13019 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19270);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1265, Current, 19270);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1266_13020 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F1266_13021 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19265);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1265, Current, 19265);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1266_13022 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19266);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1265, Current, 19266);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1266_13023 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1265, Current, 0, 0, 19267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1265, Current, 19267);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1266_13024 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1265, Current, 0, 1, 19268);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1265, Current, 19268);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (!(EIF_BOOLEAN)(arg1 == tp1)) {
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10719, dtype))(Current)).it_p);
	...
	if (!tb2) {
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10721, dtype))(Current)).it_p);
