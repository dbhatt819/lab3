...
extern void F1615_3681(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1615_3682(EIF_REFERENCE);
extern void F1615_3683(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_3684(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_3685(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_3686(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1615_3687(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1615_3688(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1615_3681 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 1, 1, 16462);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16462);
	{
...
/* {LINKED_STACK}.item */
EIF_TYPED_VALUE F1615_3682 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 1, 0, 16463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16463);
	RTIV(Current, RTAL);
	if (RTAL & CK_CHECK) {
		RTHOOK(1);
...
/* {LINKED_STACK}.force */
void F1615_3683 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 0, 1, 16464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16464);
	RTCC(arg1, 1614, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
/* {LINKED_STACK}.extend */
void F1615_3684 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 0, 1, 16465);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16465);
	RTCC(arg1, 1614, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {LINKED_STACK}.put */
void F1615_3685 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 0, 1, 16466);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16466);
	RTCC(arg1, 1614, l_feature_name, 1, RTWCT(2375, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {LINKED_STACK}.remove */
void F1615_3686 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1614, Current, 0, 0, 16467);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16467);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1615_3687 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1614, Current, 1, 0, 16468);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16468);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1615_3688 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 3, 1, 16469);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16469);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
