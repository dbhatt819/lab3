...
extern EIF_TYPED_VALUE F1389_14574(EIF_REFERENCE);
...
RTOID (F1389_14574)
EIF_TYPED_VALUE F1389_14574 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1388, Current, 0, 0, 21161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1388, Current, 21161);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
