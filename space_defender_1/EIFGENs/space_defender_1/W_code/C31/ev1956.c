...
extern EIF_TYPED_VALUE F1956_24787(EIF_REFERENCE);
static EIF_TYPED_VALUE F1956_24788_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1956_24788(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1956_24787 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30653);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30653);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_5 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7827, dtype))(Current)).it_i4);
	ti4_6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10245, dtype))(Current)).it_i4);
	ti4_7 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10244, dtype))(Current)).it_i4);
...
static EIF_TYPED_VALUE F1956_24788_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1955, Current, 0, 0, 30654);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1955, Current, 30654);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1956_24788 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15669, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1956_24788_body (Current)).it_r;
