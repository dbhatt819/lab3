...
extern EIF_TYPED_VALUE F1639_18568(EIF_REFERENCE);
extern void F1639_18569(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1639_18568 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1639_18569 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1638, Current, 0, 0, 25226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1638, Current, 25226);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14791, 0xF80006D9, 0); /* implementation */
