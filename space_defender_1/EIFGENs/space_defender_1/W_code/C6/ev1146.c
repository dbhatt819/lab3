...
extern void F1146_10166(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1146_10167(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1146(void);
extern EIF_REFERENCE _A1146_184_2_3_4_5();
...
#define ui4_1 ui4_1x.it_i4
	...
	*((EIF_INTEGER_32 *)tr3+3) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr4= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1146_184_2_3_4_5, (EIF_POINTER)(0),7765, tr2, 0, 1, -1, tr1, 4);
	}
	ur1 = RTCCL(tr4);
...
void F1146_10166 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x, EIF_TYPED_VALUE arg5x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1145, Current, 0, 5, 16716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1145, Current, 16716);
	{
		...
		RTCC(arg5, 1145, l_feature_name, 5, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	{
