...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1147, Current, 1, 0, 17825);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1148_11503_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1147, Current, 0, 0, 17826);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1148_11503 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9280,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(9280, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1148_11503_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9280,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
static EIF_TYPED_VALUE F1148_11505_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1147, Current, 0, 0, 17828);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1148_11505 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9282,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(9282, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1148_11505_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9282,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
...
static EIF_TYPED_VALUE F1148_11507_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1147, Current, 0, 0, 17830);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1148_11507 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9284, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1148_11507_body (Current)).it_r;
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 9286, 0xF8000542, 0); /* hide_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
		*(EIF_REFERENCE *)(Current + RTWA(9286, dtype)) = (EIF_REFERENCE) tr1;
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
		RTCT("not_void", EX_POST);
...
static EIF_TYPED_VALUE F1148_11509_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1148_11509 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(9286,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(9286, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1148_11509_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(9286,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
